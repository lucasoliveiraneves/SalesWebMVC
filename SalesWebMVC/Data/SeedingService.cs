...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            //Seller
            Seller s1 = new Seller(1, "Diego Oliveira Medeiros", "diego123@gmail.com", new DateTime(1987, 09, 11), 1000.0, d2);
            Seller s2 = new Seller(2, "Dayane Oliveira Medeiros", "dayane123@gmail.com", new DateTime(1988, 10, 14), 1500.0, d3);
            Seller s3 = new Seller(3, "Lucas Oliveira Neves", "lcs123@gmail.com", new DateTime(1993, 07, 21), 2500.0, d1);
            Seller s4 = new Seller(4, "Milane Almeida de Souza Oliveira ", "milane123@gmail.com", new DateTime(1998, 05, 10), 1500.0, d3);
            Seller s5 = new Seller(5, "Renilda das Gracas de Oliveira", "renilda123@gmail.com", new DateTime(1968, 07, 09), 1500.0, d3);
            Seller s6 = new Seller(6, "Cecilia Oliveira Almeida", "cecilia123@gmail.com", new DateTime(2019, 07, 11), 3500.0, d4);
